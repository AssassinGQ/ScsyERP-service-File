...
## 权限的初始化数据
insert into t_my_file(corporation, type, name, extension, content) values (1, "picture", "picture_1", "jpg", "12345");
insert into t_my_file(corporation, type, name, extension, content) values (1, "picture", "picture_2", "png", "54321");